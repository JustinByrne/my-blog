<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-nav.responsive-link :href="route('pages.index')" :active="request()->routeIs('pages.*')">
                {{ __('Pages') }}
            </x-nav.responsive-link>
            <x-nav.responsive-link :href="route('articles.index')" :active="request()->routeIs('articles.*')">
                {{ __('Articles') }}
            </x-nav.responsive-link>
            <x-nav.responsive-link :href="route('categories.index')" :active="request()->routeIs('categories.*')">
                {{ __('Categories') }}
            </x-nav.responsive-link>
            <x-nav.responsive-link :href="route('tags.index')" :active="request()->routeIs('tags.*')">
                {{ __('Tags') }}
            </x-nav.responsive-link>
