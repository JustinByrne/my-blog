            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-end pb-3">
                        <a href="{{ route('pages.create') }}" class="shadow rounded-lg px-3 py-2 text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            New Page
                        </a>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 whitespace-nowrap text-sm font-medium">
                                                        <div class="flex justify-around">
                                                            ...
                                                            @endif
                                                            <a href="{{ route('pages.edit', $page->slug) }}" class="text-indigo-600 hover:text-indigo-900">
                                                                Edit
                                                            </a>
                                                            <a
